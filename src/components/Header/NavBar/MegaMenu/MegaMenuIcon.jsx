const iconClass =
  "w-4.5 h-4.5 fill-current text-[#574a6d] group-hover/parent:text-[#ed1944]";

const MegaMenuIcon = ({ name }) => {
  switch (name) {
    case "mobile":
      return (
        <svg
    ...
    case "home-appliances":
      return (
        <svg
          ...
          viewBox="0 0 24 25"
        >
          <path d="M5.738 5.989v2.99h-1.5V5.99h1.5zM5.738 12.968v2.991h-1.5v-2.991h1.5zM18.806 20.793a.877.877 0 11-1.754 0 .877.877 0 011.754 0z" />
          <path
            fillRule="evenodd"
            d="M15.571 7.711V1.95a.95.95 0 00-.95-.95H1.95a.95.95 0 00-.95.95V24h22v-3.414c0-.926-.42-1.753-1.078-2.304l.89-10.57h-3.72v-1h-2.5v1h-1.02zM3 3v7.253h7.13V9.71a2 2 0 012-2h1.441V3H3zm9.684 19v-1.414c0-1.001.49-1.888 1.243-2.433l-.212-2.516h-1.584a2 2 0 01-2-2v-1.884H3V22h9.684zm.532-12.291H12.13v3.928h1.416l-.331-3.928zm2.468 9.875H20a1 1 0 011 1V22h-6.316v-1.414a1 1 0 011-1zm-.46-9.875l.662 7.867h1.294v-.869h-.69v-1.5h2.875v1.5h-.685v.869h1.294l.663-7.867h-5.414z"
            clipRule="evenodd"
          />
        </svg>
      );
    ...
    case "kids-baby-toys":
      return (
        <svg
          ...
          viewBox="0 0 18 18"
        >
          <path d="M11.25 10.5H15V12h-3.75v-1.5z" />
          <path
            fillRule="evenodd"
    ...
    case "local-products":
      return (
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M15.5 1v3l-3 3V4l3-3zM11.5 9v2.984L8.5 9v3l3 3v8.005L7 23l-.5-1C8 22 9 21.395 9 20c0-1.6-1.12-2.72-2.464-4.064C4.52 13.92 2 11.4 2 6h6.5l3 3zM12.5 9v2.984L15.5 9v3l-3 3v8.005L17 23l.5-1C16 22 15 20.895 15 19.5c0-1.6 1.12-2.64 2.464-3.888C19.48 13.74 22 11.4 22 6h-6.5l-3 3zM8.5 4V1l3 3v3l-3-3z" />
        </svg>
      );
    ...
    case "pet-shop":
      return (
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M12 22c-2.267 0-4.414-.855-6.09-2.356C4.622 18.49 4 17.023 4 15.5c0-2.07 1.336-3.788 3.521-4.744-.323-.493-.521-1.084-.521-1.756C7 7.343 8.343 6 10 6c.768 0 1.468.289 2 .764A2.986 2.986 0 0114 6c1.657 0 3 1.343 3 3 0 .672-.198 1.263-.521 1.756C18.664 11.712 20 13.43 20 15.5c0 1.523-.622 2.99-1.91 4.144A8.93 8.93 0 0112 22zM8 4.5C8 3.12 8.895 2 10 2s2 .895 2 2-.895 2-2 2-2-.895-2-2zm4 0c0-1.105.895-2 2-2s2 .895 2 2-.895 2-2 2-2-.895-2-2zM4.5 9C3.672 9 3 8.104 3 7s.672-2 1.5-2S6 5.896 6 7s-.672 2-1.5 2zM19.5 9C18.672 9 18 8.104 18 7s.672-2 1.5-2S21 5.896 21 7s-.672 2-1.5 2z" />
        </svg>
      );
